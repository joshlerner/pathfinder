...
==[[Move]]== ==[[Secret]]==
___
You attempt to move to another place while becoming or staying [[undetected]]. [[Stride]] up to half your Speed. (You can use Sneak while [[Burrow|Burrowing]], [[Climb|Climbing]], [[Fly|Flying]], or [[Swim|Swimming]] instead of Striding if you have the corresponding movement type; you must move at half that Speed.)
...
**Source** *Pathfinder Player Core pg. 245 <sup>2.0</sup>*